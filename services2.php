       ...
       <!--Start breadcrumb area-->
        ...
        <section class="main-project-area style2">
            ...
            <div class="sec-title text-center wow fadeInDown" data-wow-delay="100ms" data-wow-duration="1200ms">
                ...
                <div class="sec-title text-center wow fadeInDown  pd-5" data-wow-delay="100ms" data-wow-duration="1200ms">
                    <p class="p-sz">Modular Kitchen</p>
                </div>
                <div class="row filter-layout masonary-layout">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item contem ret">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                    <img src="images/services/kitchen1.jpg" alt="Awesome Image" class="ser-img">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod trad">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/kitchen2.jpeg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/kitchen3.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                ...
                <div class="row filter-layout masonary-layout">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item contem ret">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/living1.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod trad">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/living2.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/living3.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                ...
                <!-- 3rd type -->
                <div class="sec-title text-center wow fadeInDown pd-5" data-wow-delay="100ms" data-wow-duration="1200ms">
                    <p class="p-sz">Office Interior Services</p>
                </div>
                <div class="row filter-layout masonary-layout">
                    <!--Start single project item-->
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item contem ret">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/office1.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod trad">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/office2.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 filter-item mod contem">
                        <div class="single-project-style5">
                            <div class="img-holder">
                                <div class="inner">
                                <img src="images/services/office3.jpg" alt="Awesome Image" class="ser-img">
                                    <div class="overlay-box">
                                        <div class="box">
