                ...
                <div class="row fact-counter">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-fact-counter wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="count-box">
                                <h1>
                                    <span class="timer" data-from="1" data-to="200" data-speed="5000" data-refresh-interval="50">200</span>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-fact-counter wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="count-box">
                                <h1>
                                    <span class="timer" data-from="1" data-to="2000" data-speed="5000" data-refresh-interval="50">2000</span>
                                </h1>
                            </div>
                            <div class="title">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-team-member">
                            <div class="img-holder">
                                <img src="images/team/member1.png" alt="Awesome Image">
                                <div class="overlay1">
                                    <div class="box">
                                        <div class="link">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="single-team-member">    
                            <div class="img-holder">
                            <img src="images/team/member3.jpg" alt="Awesome Image" style="width:80%">
                                <div class="overlay1">
                                    <div class="box">
                                        <div class="link">
                                            <!-- <a class="btn-two" href="blog.html">View Profile<span class="flaticon-next"></span></a> -->
