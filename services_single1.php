                        ...
                        <div class="single-service-sidebar">
                            ...
                            <div class="sidebar-contact-box text-center">
                                <div class="inner-content">
                                    ...
                                    <div class="button">
                                        <a class="btn-one wow slideInUp animated" data-wow-delay="0ms" data-wow-duration="1500ms" href="#" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: slideInUp;">Make Appointment
                            ...
                            <div class="inner-content">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="single-pricing-box wow fadeInLeft animated" data-wow-delay="100ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 100ms; animation-name: fadeInLeft;">
                                            <div class="inner">
                                                <div class="img-box">
